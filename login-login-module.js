...
/* harmony import */ var _restaurants_admin_settings_accesscontrol_user__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../restaurants/admin/settings/accesscontrol/user */ "./src/app/restaurants/admin/settings/accesscontrol/user.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var LoginComponent = /** @class */ (function () {
    ...
    LoginComponent.prototype.ngOnInit = function () {
        this.user = new _restaurants_admin_settings_accesscontrol_user__WEBPACK_IMPORTED_MODULE_4__["user"]();
    };
        ...
        this.loginService.logIn(this.user).subscribe(function (data) {
            ...
            if (_this.password == _this.user.password) {
                if (_this.user.status == 'Active') {
                    if (_this.role[0].role == 'SUPERADMIN' || _this.role[0].role == 'ADMIN' || _this.role[0].role == 'COUNTER') {
                        _this.router.navigate(['restaurants/admin']);
                    }
                    else if (_this.role[0].role == 'WAITER') {
                        _this.router.navigate(['restaurants/waiter']);
                    }
                    else if (_this.role[0].role == 'COOK') {
                        _this.router.navigate(['restaurants/kitchen']);
                    }
                }
                else {
    ...
    LoginModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            imports: [_angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"], _login_routing_module__WEBPACK_IMPORTED_MODULE_2__["LoginRoutingModule"],
                _angular_material__WEBPACK_IMPORTED_MODULE_4__["MatInputModule"], _angular_material__WEBPACK_IMPORTED_MODULE_4__["MatSelectModule"], _angular_material__WEBPACK_IMPORTED_MODULE_4__["MatButtonModule"], _angular_material__WEBPACK_IMPORTED_MODULE_4__["MatIconModule"],
                _angular_forms__WEBPACK_IMPORTED_MODULE_5__["FormsModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_5__["ReactiveFormsModule"], _angular_http__WEBPACK_IMPORTED_MODULE_7__["HttpModule"]
            ], providers: [
